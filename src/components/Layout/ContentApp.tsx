  ...
  return (
    <main className="flex-1 flex flex-col">
      ...
      <header className="bg-white dark:bg-gray-900 shadow-md p-4 flex items-center justify-between md:hidden">
        ...
        <span className="text-xl font-semibold text-text-main dark:text-white">Musila App</span>
        <ToggleSwitch />
      </header>
      ...
      <div className="flex-1 p-6 bg-white dark:bg-gray-900">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-text-main dark:text-white">Contenido de la Aplicación</h1>
