...
export default function LoginForm({ onLoginSuccess }: { onLoginSuccess: (email: string) => void }) {
  ...
  return (
    <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex items-center justify-between">
        ...
        <a href="#" className="text-sm font-medium text-primary hover:underline dark:text-primary">¿Olvidaste la contraseña?</a>
      </div>
      ...
      <p className="text-sm font-light text-text-secondary dark:text-gray-400">
        ¿No tienes una cuenta? <a href="#" className="font-medium text-primary hover:underline dark:text-primary">Regístrate</a>
      </p>
    </form>
  );
}
