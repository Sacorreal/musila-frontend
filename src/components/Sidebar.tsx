  ...
  return (
    <>
      ...
      <aside className={`
        ...
        ${isOpen ? 'translate-x-0' : '-translate-x-full'} // Controla el deslizamiento en móvil
      `} onClick={(e) => e.stopPropagation()}>
        
        {/* Encabezado del Sidebar */}
        <div className="flex items-center mb-6">
          <Image className="w-10 h-10 mr-2 rounded-lg" src="/logo.webp" alt="logo" width={40} height={40} />
        ...
        <nav className="flex-grow">
          <ul className="space-y-2">
            <li>
              <a href={routes.dashboard} className="flex items-center p-2 text-text-main dark:text-gray-100 rounded-lg hover:bg-primary hover:text-white dark:hover:bg-primary-dark transition-colors">
                {/* Icono de Dashboard */}
            ...
            <li>
              <a href={routes.songs} className="flex items-center p-2 text-text-main dark:text-gray-100 rounded-lg hover:bg-primary hover:text-white dark:hover:bg-primary-dark transition-colors">
                {/* Icono de Canciones */}
