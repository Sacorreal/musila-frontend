...
import { Notification as NotificationType } from "../../../../domains/song/types";
...
export function Notification() {
  ...
  const getNotificationStyles = (type: NotificationType["type"]) => {
    const baseStyles =
      "fixed top-4 right-4 p-4 rounded-lg shadow-lg max-w-sm z-50 transition-all duration-300 border";
