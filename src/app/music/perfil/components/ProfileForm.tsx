...
import { AvatarUploader } from "../../../../domains/music/components/AvatarUploader";
...
const profileSchema = z
  .object({
    ...
    bio: z
      .string()
      .max(280, "La biografía no puede exceder 280 caracteres")
      .optional(),
    ubicacion: z
      .string()
      .max(60, "La ubicación no puede exceder 60 caracteres")
      .optional(),
    links: z
      .object({
  ...
  .refine(
    (data) => {
      if (data.passwordActual || data.passwordNueva) {
        return (
          data.passwordActual && data.passwordNueva && data.passwordConfirmacion
        );
      }
      return true;
    },
    {
      message:
        "Todos los campos de contraseña son requeridos para cambiar la contraseña",
