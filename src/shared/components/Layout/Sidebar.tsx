    ...
    <>
      ...
      >
        ...
        <div className="mt-auto">
          ...
          <button
            onClick={logout}
            className="w-full flex items-center justify-center p-2 mt-4 text-error bg-error/10 rounded-lg hover:bg-red-500 hover:text-white transition-colors cursor-pointer"
          >
            <svg
